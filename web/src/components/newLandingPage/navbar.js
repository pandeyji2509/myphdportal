  ...
  return (
      <div className="h-24 font-['IBM_Plex_Sans'] bg-[#181c2c] flex">
        ...
        <div className="justify-end items-center text-md font-medium text-white w-1/2 flex">
          <Link to ="/newlanding"><div className="mx-4 hover:underline hover:underline-offset-4 p-2 px-4 rounded-md"> Home</div></Link>
          <Link to ="/newlanding"><div className="mx-4 hover:underline hover:underline-offset-4 p-2 px-4 rounded-md">About Us</div></Link>
          <Link to="/newlanding/notice"><div className="mx-4 hover:underline hover:underline-offset-4 p-2 px-4 rounded-md">Notices</div></Link>
          <Link to ="/newlanding"><div className="mx-4 hover:underline hover:underline-offset-4 p-2 px-4 rounded-md">Contact</div></Link>
        </div>
      </div>
  );
};
