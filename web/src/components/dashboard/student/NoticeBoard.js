...
const NoticeBoard = () => {
    ...
    return (
            ...
            <div className={`${darkMode ? "bg-gray-800 text-white" : "bg-white  shadow-md"} rounded-md`}>
                ...
                <div className="p-4">
                    <div className={`p-2 text-center rounded-md font-bold w-1/5 cursor-pointer ${darkMode ? "bg-blue-500 hover:bg-blue-600" : "bg-blue-600 hover:bg-blue-500 text-white"}`} >VIEW MORE</div>
                </div>
