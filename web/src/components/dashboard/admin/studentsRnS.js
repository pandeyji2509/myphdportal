...
const StudentRnS = () => {
  ...
  return (
    <>
        ...
        {students.filter(student => student.isApproved === true).map((student, index) => (
            <div className={`my-2 flex bg-white shadow-sm items-center rounded-lg py-2 px-3 text-sm`}>
                ...
                <div className="w-[8%]">{student.mobileNumber}</div>
