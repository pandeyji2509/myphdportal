...
const ViewStudentDui = () => {
  ...
  const handleApprove = async () => {
    try {
      await axios.put(
        `${process.env.REACT_APP_SERVER_ENDPOINT}/api/v1/admin/approveDui/${stu._id}`, {
          flag:true
        }
      );
  ...
  return (
    <div className="px-8 py-4">
      <div className="font-medium text-lg w-fit mb-4 hover:text-blue-600 cursor-pointer">
        <Link to="/admin/studentsDui"> {"< Back"}</Link>
      </div>
      <div className="flex">
      <div className="bg-white w-3/4 shadow-md rounded-md">
       ...
       <div className="w-1/4 ml-4">
            ...
            <div className={`shadow-md my-4 px-4 py-2 font-semibold text-white rounded-md flex ${
                ...
                <div className="w-5/6 text-sm">Approve</div>
